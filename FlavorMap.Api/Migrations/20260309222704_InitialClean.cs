        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiningFormat = table.Column<string>(type: "TEXT", nullable: false),
                    ImageUrl = table.Column<string>(type: "TEXT", nullable: false),
                    Season = table.Column<string>(type: "TEXT", nullable: false),
                    MenuSeasonality = table.Column<string>(type: "TEXT", nullable: false),
                    DiningMoodExperience = table.Column<string>(type: "TEXT", nullable: false),
                    FoodWeight = table.Column<string>(type: "TEXT", nullable: false),
                    CulturalNarratives = table.Column<string>(type: "TEXT", nullable: false),
